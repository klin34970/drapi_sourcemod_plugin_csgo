...
stock InstallNew()
{
	...
	/* Create ROUND table */ 
	Format(query, sizeof(query), "CREATE TABLE IF NOT EXISTS `round` (`id` int(11) NOT NULL AUTO_INCREMENT, `map` varchar(32) NOT NULL, `auth` varchar(64) NOT NULL, `time` float NOT NULL, `jumps` int(11) NOT NULL, `style` int(11) NOT NULL, `track` int(11) NOT NULL, `name` varchar(64) NOT NULL, `finishcount` int(11) NOT NULL, `stage` int(11) NOT NULL, `fpsmax` int(11) NOT NULL, `jumpacc` float NOT NULL, `strafes` int(11) NOT NULL, `strafeacc` float NOT NULL, `avgspeed` float NOT NULL, `maxspeed` float NOT NULL, `finishspeed` float NOT NULL, `flashbangcount` int(11) NULL, `rank` int(11) NOT NULL, `replaypath` varchar(256) NOT NULL, `custom1` varchar(32) NULL, `custom2` varchar(32) NULL, `custom3` varchar(32) NULL, date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (`id`), UNIQUE KEY `single_record` (`auth`, `map`, `style`, `track`)) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
	Timer_LogInfo("[timer-mysql.smx] Query: %s", query);
	SQL_TQuery(g_hSQL, EmptyCallback, query, _, DBPrio_High);
	...
	/* Create RANKS table */ 
	Format(query, sizeof(query), "CREATE TABLE IF NOT EXISTS `ranks` (`auth` varchar(64) NOT NULL PRIMARY KEY, `points` int(11) NOT NULL default 0, `lastname` varchar(65) NOT NULL default '', `lastplay` int(11) NOT NULL default 0) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
	Timer_LogInfo("[timer-mysql.smx] Query: %s", query);
	SQL_TQuery(g_hSQL, EmptyCallback, query, _, DBPrio_High);
	
	/* Create CHECKPOINTS table */ 
	Format(query, sizeof(query), "CREATE TABLE IF NOT EXISTS `timercheckpoints` (`steamid` varchar(64) NOT NULL PRIMARY KEY, `name` varchar(64) NOT NULL default '', `map` varchar(64) NOT NULL default '', `level` int(11) NOT NULL default '0', `levelname` varchar(128) NOT NULL default '', `time` float NOT NULL, `track` int(11) NOT NULL default '0', `style` int(11) NOT NULL default '0') ENGINE=InnoDB DEFAULT CHARSET=utf8;");
	Timer_LogInfo("[timer-mysql.smx] Query: %s", query);
	SQL_TQuery(g_hSQL, EmptyCallback, query, _, DBPrio_High);
