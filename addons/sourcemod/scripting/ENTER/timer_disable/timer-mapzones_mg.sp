...
public Action:CheckRemainingTime(Handle:timer)
{
	...
	if (iTimeLimit > 0)
	{
		...
		if(GetEngineVersion() == Engine_CSGO)
		{
			switch(timeleft)
			{
				case 1800: 	{CPrintToChatAll("[{GREEN}Z4E-INFO{NORMAL}] Current Map: {BLUE}%s", g_currentMap); CPrintToChatAll("[{GREEN}Z4E-INFO{NORMAL}] Time Remaining: {PINK}30 minutes");}
				case 1200: 	{CPrintToChatAll("[{GREEN}Z4E-INFO{NORMAL}] Current Map: {BLUE}%s", g_currentMap); CPrintToChatAll("[{GREEN}Z4E-INFO{NORMAL}] Time Remaining: {PINK}20 minutes");}
				case 600: 	{CPrintToChatAll("[{GREEN}Z4E-INFO{NORMAL}] Current Map: {BLUE}%s", g_currentMap); CPrintToChatAll("[{GREEN}Z4E-INFO{NORMAL}] Time Remaining: {PINK}10 minutes");}
				case 300: 	{CPrintToChatAll("[{GREEN}Z4E-INFO{NORMAL}] Current Map: {BLUE}%s", g_currentMap); CPrintToChatAll("[{GREEN}Z4E-INFO{NORMAL}] Time Remaining: {PINK}5 minutes");}
				case 120: 	{CPrintToChatAll("[{GREEN}Z4E-INFO{NORMAL}] Current Map: {BLUE}%s", g_currentMap); CPrintToChatAll("[{GREEN}Z4E-INFO{NORMAL}] Time Remaining: {PINK}2 minutes");}
				case 60: 	{CPrintToChatAll("[{GREEN}Z4E-INFO{NORMAL}] Current Map: {BLUE}%s", g_currentMap); CPrintToChatAll("[{GREEN}Z4E-INFO{NORMAL}] Time Remaining: {PINK}60 seconds");}
				case 30: 	{CPrintToChatAll("[{GREEN}Z4E-INFO{NORMAL}] Current Map: {BLUE}%s", g_currentMap); CPrintToChatAll("[{GREEN}Z4E-INFO{NORMAL}] Time Remaining: {PINK}30 seconds");}
				case 15: 	{CPrintToChatAll("[{GREEN}Z4E-INFO{NORMAL}] Current Map: {BLUE}%s", g_currentMap); CPrintToChatAll("[{GREEN}Z4E-INFO{NORMAL}] Time Remaining: {PINK}15 seconds");}
				//case -1: 	CPrintToChatAll("{PINK}3..");
				//case -2: 	CPrintToChatAll("{PINK}2..");
				/*case -3:
				{
					CPrintToChatAll("{PINK}1..");
