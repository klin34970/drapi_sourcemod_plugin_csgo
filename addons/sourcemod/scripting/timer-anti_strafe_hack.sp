...
public ConnectSQLCallback(Handle:owner, Handle:hndl, const String:error[], any:data)
{
	...
	if (StrEqual(driver, "mysql", false))
	{
		...
		SQL_TQuery(g_hSQL, CreateSQLTableCallback, "CREATE TABLE IF NOT EXISTS `strafe` (`id` int(11) NOT NULL AUTO_INCREMENT, `map` varchar(32) NOT NULL, `auth` varchar(64) NOT NULL, `style` int(11) NOT NULL, `strafes` int(11) NOT NULL, `strafes0` int(11) NOT NULL, `strafes1` int(11) NOT NULL, `strafes2` int(11) NOT NULL, `strafes3` int(11) NOT NULL, `strafes4` int(11) NOT NULL, `strafes5` int(11) NOT NULL, `strafes6` int(11) NOT NULL, `strafes7` int(11) NOT NULL, `strafes8` int(11) NOT NULL, `strafes9` int(11) NOT NULL, `strafes10` int(11) NOT NULL, date TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (`id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8;");
	}
